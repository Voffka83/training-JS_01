...
let z2 = 3;
let z3 = (z1 * z2);
document.querySelector('.out-14').innerHTML = z3;
...
let y2 = 3;
let y3 = (y1 / y2);
document.querySelector('.out-15').innerHTML = y3;
...
let x2 = 5;
let x3 = x1 + x2;
document.querySelector('.out-16').innerHTML = x3;
...
console.log(out19);
out19.innerHTML = '<div class="out-19">это out-19</div>';
console.log(out19); //вот этот таск совсем не понял
